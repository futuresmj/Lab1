...
knitr::opts_knit$set(root.dir = "/Lab1/")
```
...
# How do you explain the result for tricky? Because of the order of hierarchy.If only there is a character assigned in a variable, no matter how many numerics in the variable, the variable will be converted to class "character" automatically.
```
...
<Three, so far. Numeric, char and logical.>

# Question 3
```{r}
# Build a vector of the study semesters (Winter2015  through Winter2020): 
semesters <- c(Winter2015, Winter2016, Winter2017, Winter2018, Winter2019, Winter2020)
